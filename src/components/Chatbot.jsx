...
export default function ChatBot() {
  ...
  const storeInfo = `
Brand: We are a handcrafted home decor brand from Nigeria, specializing in sustainable, jute-based products.

Ordering: You can place an order directly via WhatsApp. We respond within 2 hours during working hours.

Shipping: We deliver across Nigeria and internationally. Local orders are delivered within 5–7 days.

Returns: We accept returns within 7 days of delivery if the product is unused and in original condition.

Custom Orders: Yes! You can request custom sizes or designs for wall hangings, baskets, and more.

Material: All our products are handmade using natural jute and recycled materials, 100% plastic-free.

Tone: Friendly, warm, and helpful — reflect the personal, handmade nature of the brand.
`;
  ...
  useEffect(() => {
    if (isOpen && !hasGreeted && !showWelcome) {
      setIsTyping(true);
      const welcomeText =
        "Hey there! I can help you choose the perfect jute decor or answer any questions. Just ask! 🌿";
